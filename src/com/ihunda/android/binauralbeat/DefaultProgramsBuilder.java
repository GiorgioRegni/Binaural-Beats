...
public class DefaultProgramsBuilder {
	...
	public static Program SELF_HYPNOSIS(Program p) {
		...
		p.addPeriod(new Period(300, SoundLoop.WHITE_NOISE, 0.5f, null).
				addVoice(new BinauralBeatVoice(12f, 4f, 0.6f)).
				setV(new HypnoFlash())
		).
		addPeriod(new Period(600, SoundLoop.WHITE_NOISE, 0.5f, null).
				addVoice(new BinauralBeatVoice(4f, 4f, 0.65f)).
				setV(new HypnoFlash())
		).
		addPeriod(new Period(300, SoundLoop.WHITE_NOISE, 0.5f, null).
	...
	public static Program AWAKE(Program p) {
		...
		p.addPeriod(new Period(120, SoundLoop.WHITE_NOISE, 0.5f, null).
		...
		addPeriod(new Period(120, SoundLoop.WHITE_NOISE, 0.5f, null).
	...
	public static Program UNITY(Program p) {
		...
		p.addPeriod(new Period(3600, SoundLoop.UNITY,  0.7f, null).
